class Game {
    ...
    doTick() {
       /* let coord = this.snake.body[0];
        ...
        this.setTimer(this.snake.body.length.toString())
    }
    ...
    setTimer(text){
        let str = "длина змейки:" + text + "; до выигрыша осталось: " + (this.settings.winLength - this.snake.body.length).toString();
        this.timerEl.innerText = str;
    }
    /*withOutBoards(coord){
        let currentHeadCoords = coord;
        let newHeadCoords = {
